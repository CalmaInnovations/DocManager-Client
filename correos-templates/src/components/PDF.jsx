    ...
    return(
        <Document>
            <Page style={styles.page}>
                <Text style={styles.title}>CONSTANCIA DE ACEPTACIÓN</Text>
                <View style={styles.section}>
                    <Text>
                        A quien corresponda,
                        Por la presente, la FUNDACIÓN CALMA, identificada con RUC N° 20600792220,
                        deja constancia de la aceptación de _________________, portador del DNI
                        N° ________ para realizar Prácticas __________________ en el área de
                        ________________. Esta área se enfoca en la sensibilización y concientización sobre la
                        instauración de una Cultura de Paz en la sociedad, alineándose con su formación
                        en ____________________.
                        La práctica iniciará el día ____________________ y finalizará el ____________________.
                        Durante este periodo, ________ desarrollará funciones clave que incluirán
                        supervisión, seguimiento, elaboración de informes y coordinación dentro de la
                        Fundación.
                        Estamos comprometidos en proporcionar un entorno de aprendizaje enriquecedor
                        que contribuya al desarrollo profesional y personal de ________, dotándola de
                        herramientas valiosas para su futuro en el campo laboral.
                        Este documento se expide a solicitud del interesado para efectos pertinentes.
                        Atentamente,
                    </Text>
                </View>
